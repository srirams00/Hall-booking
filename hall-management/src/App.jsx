...
function App() {
  ...
  const handleAdminLogin = useCallback((adminName) => {
  ...
  const handleNewBooking = useCallback(async (booking) => {
  ...
  const handleUpdateBookingStatus = useCallback(async (bookingId, status, rejectionReason = "") => {
    try {
